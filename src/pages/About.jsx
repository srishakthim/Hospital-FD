...
export default function AboutUs() {
  ...
  const tabs = {
    vision: {
      ...
      image:
        "https://www.shardahospital.org/assests/images/vision-mission-sharda-hospital.jpg",
    },
    mission: {
      title: "Our Mission",
      ...
      image:
        "https://www.ancoracc.org/hs-fs/hubfs/Images/nurse-with-older-lady_55650448.png?width=1800&height=1200&name=nurse-with-older-lady_55650448.png",
    },
    values: {
      title: "Values",
      ...
      image: "https://manyahealthcare.com/img/pf3.jpg",
    },
  };
  ...
  return (
    <div className="bg-white text-gray-800">
      ...
      <div className="bg-indigo-50 py-10">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row md:items-center md:justify-between gap-8 my-10">
          <div>
          ...
          <div className="flex justify-center md:w-1/2">
            <img
              ...
              alt="Hospital"
              className="rounded-2xl shadow-lg border-4 border-green-100 max-w-full h-auto"
            />
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-4 leading-relaxed">
            PUKRA Multispeciality Hospital in Coimbatore was established in 1952
            by the Kuppuswamy Naidu Charitable Trust to care for Women and
            Children. Since then, this institution has grown to encompass the
            entire spectrum of multi specialities of healthcare under one roof.
            Being the most renowned, trusted and the best hospital in
            Coimbatore, we take utmost care in treating the people with the most
            advanced technologies that help people to recover quickly.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-6">
          ...
          <div className="bg-indigo-50 p-6 rounded-xl text-center shadow-sm col-span-2 sm:col-span-1">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="relative mt-12">
          ...
          <div className="flex items-center justify-center gap-6 overflow-x-auto scrollbar-hide px-10">
            {timelineData.map((item, index) => (
              ...
              >
                <img
                  src={item.img}
                  alt={item.year}
                  className={`h-16 sm:h-20 w-24 sm:w-28 object-cover rounded-lg shadow ${
                    activeIndex === index
                      ? "opacity-100"
                      : "opacity-40 blur-sm"
                  }`}
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-indigo-800 font-medium mt-4">
              ...
              He established Lakshmi Mills Company, a major textile yarn and
              cloth manufacturer, in 1910 in Coimbatore, India.
            </p>
            <p className="text-gray-700 mt-4 leading-relaxed">
              G.Kuppuswamy Naidu felt the urge in him to build a hospital for
              women and children after his step-sister, Smt. Rajammal and her
              child’s demise. His dream was fulfilled by his brother & sons. The
              hospital started to serve the women & children at the early stages.
            </p>
            ...
            <div className="mt-10 border rounded-xl shadow-sm bg-white p-6 relative">
              <p className="text-indigo-800 text-lg font-medium italic">
                “I am determined I shall do no other charity till I build a
                hospital for women and children in Coimbatore”
              </p>
          ...
          <div className="flex flex-col items-center text-center">
            <img
              ...
              alt="Founder"
              className="w-52 sm:w-64 h-64 sm:h-72 object-contain rounded-lg"
            />
            <p className="mt-4 text-indigo-700 font-semibold">Founder</p>
            <p className="text-gray-900 font-medium">Sri.G.Kuppuswamy Naidu</p>
